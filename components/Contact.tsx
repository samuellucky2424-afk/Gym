    ...
    <section id="contact" className="py-16 md:py-24 bg-zinc-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            <h2 className="text-emerald-600 font-black text-xs md:text-sm uppercase tracking-[0.3em] mb-4">Get In Touch</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 md:gap-8 mb-12">
              ...
              <div className="flex items-start gap-4 md:gap-6 sm:col-span-2 lg:col-span-1">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 font-bold text-emerald-500 uppercase tracking-widest text-xs md:text-sm">{CONTACT_INFO.hours}</p>
                </div>
              </div>
            </div>
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        required
                        type="text"
                        className="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-all text-sm md:text-base"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select required className="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-all appearance-none text-sm md:text-base">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      required
                      className="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl px-4 py-3 h-24 md:h-32 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-all resize-none text-sm md:text-base"
                      placeholder="How can we help you?"
                    ></textarea>
                  </div>
                  <button 
                    disabled={isSubmitting}
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 md:py-4 rounded-xl font-black tracking-widest text-base md:text-lg transition-all shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-2 min-h-[48px]"
                  >
